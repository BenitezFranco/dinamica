...
class Persona{
    ...
    public function insertar(){
        $resp = false;
        $base=new BaseDatos();
        $sql="INSERT INTO `persona` (NroDni,Apellido,Nombre,fecNac,Telefono,Domicilio)  
    ...
    public function modificar(){
        $resp = false;
        $base=new BaseDatos();
        $sql="UPDATE `persona` SET Apellido='".$this->getApellido()."', Nombre='".$this->getNombre()."',fecNac='".$this->getFecNac()."', Telefono='".$this->getApellido()."', Domicilio='".$this->getDomicilio()."' WHERE NroDni='".$this->getNroDni()."'";
        if ($base->Iniciar()) {
            if ($base->Ejecutar($sql)) {
                $resp = true;
            } else {
