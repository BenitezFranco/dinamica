...
<div class="container border rounded mt-2 mb-1">
   ...
   <div class="panel-heading">
         ...
         <form class="row g-3 needs-validation" id="miFormulario" method="post" action="accion/resultado.php" enctype="multipart/form-data" novalidate>
            <table class="table">
                <tr>
      ...
      Seleccione un genero valido.
            ...
            <div class="col-md-4">
                   ...
                   Bien!
                    ...
                    <label for="imagen" class="form-label fw-bolder">Imagen de la película:</label>
                    <input type="file" class="form-control" name="imagen" id="imagen" accept="image/*" required><br>
